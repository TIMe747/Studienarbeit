...
\begin{framed}
	\begin{algorithm}[H]
		...
		\While{Maximale Iterationen nicht erreicht}{
			...
			Berechne für jede modellierte Biene die Loyalitätswahrscheinlichkeit $L$\;
				\eIf{$L$ größer als Zufallszahl}{
				...
				\eIf{Biene im Zustand Frei}{
					...
					Bestimme Richtungsvektor $v_{i}(t)$ von Position $x_{i}(t)$ zu $r_{i}(t)$\;
