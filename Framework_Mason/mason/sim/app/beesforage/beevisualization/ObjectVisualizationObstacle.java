...
public class ObjectVisualizationObstacle extends ObjectVisualization {

	private static final long serialVersionUID = -3454893004198725770L;

	public ObjectVisualizationObstacle(IVisualAgent agent) {
		super(agent);
	}
