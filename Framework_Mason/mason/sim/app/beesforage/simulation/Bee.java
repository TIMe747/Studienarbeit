...
public class Bee extends AbstractMovingAgent {
	...
	/**
	 * The amount of nectar a bee needs for one step in the outside in [�l].
	 */
	static private final double nectarForOneStep = 1 / 80;

	/**
	 * The maximum load the bee can carry in [�l].
	 */
	 ...
	 */
	static private final double nectarForReturn = ((ForagingBeeSimulation.WIDTH
			+ ForagingBeeSimulation.HEIGHT + ForagingBeeSimulation.LENGTH) / 3)
			* nectarForOneStep;
	...
	protected void doStateUnloadQueue() {
		 ...
		 * hive is stored in ml but the nectar load is given in �l. 3)
